...
import PictureOfTheDay from './../../dashboardComponents/PictureOfTheDay';
...
function View ({name, userOptions, country, data, defaultStateSize, location}) {
    ...
    return (
        ...
        <div className="dashBoard_Bottom">
            ...
            {  data.length > 0 
                ? data.slice(0, defaultStateSize).map((el) => {
                    return (
                      <TabMain
                        tabType="Tab"
