    ...
    */
    ...
    return (
        ...
        <form className='searchForm' onSubmit = {e => e.preventDefault() }>
            ...
            <input onChange = {changeHandler} type='text' className ='searchForm_text' placeholder='Search topic...' />
            <div onClick={submitHandler} className='searchForm_icon'> <button className='searchForm_button'>Search</button></div>
            
            {
                
                <Secondmodal setModal={setModal} showModal = {showModal} result = {result} item = {item} />
            }
        </form>
